package javase8sample.chapter13.javafx8.fx2048;
...
/**
 * 包含游戏界面布局（Board）以及Grid的操作（GridOperator）
 */
public class GameManager extends Group {
     ...
     * 
     * The purpose of the game is sum the value of the tiles up to fx2048 points
     * Based on the Javascript version: https://github.com/gabrielecirulli/fx2048
     * 
